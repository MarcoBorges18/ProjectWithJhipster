package com.reactvyhealthy.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.reactvyhealthy.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.reactvyhealthy.security.DomainUserDetailsService", "createSpringSecurityUser");
